	...
	public void create () {
		...
		try {
			ScreenCreator.addAndGo(new TextLevel("O ano eh 2119, os personagens encontram-se em Delta City, "
											   ...
											   + "da antiga Nova York. É de noite, o tempo está quente, o céu "
											   + "está com nuvens de poeira e foligem provenientes dos carros que "
											   ...
											   + "esta comecando a ameacar as maiores.\n"
											   + "O telefone toca, e trás uma noticia nada agradavel: Ashley, a filha do "
